...
#define STRING_CONFIG_H_AUTHOR "(LVD, 1.1.2-AC)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 100, 100*8/9 }  // default steps per unit for Kossel (GT2, 20 tooth)
